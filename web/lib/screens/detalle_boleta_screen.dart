...
class _DetalleTernoScreenState extends State<DetalleTernoScreen> {
  ...
  Future<void> _seleccionarFecha(BuildContext context) async {
    ...
    final fechaMinima = fechaActual.add(const Duration(days: 1));
    final fechaMaxima = fechaActual.add(const Duration(days: 365));
  ...
  Future<void> _verificarDisponibilidad() async {
    ...
    try {
      // ✅ USAR ternoId en lugar de nombre/talla/color
      ...
      setState(() {
        _infoDisponibilidad = {
          'disponible': true,
          'mensaje': 'Disponible (error al verificar)',
        };
        _verificandoDisponibilidad = false;
      });
    }
