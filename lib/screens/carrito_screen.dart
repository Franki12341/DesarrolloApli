      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            const Spacer(),
            // ✅ CONTADOR de ternos (X/5)
            if (!carritoProvider.estaVacio)
              Container(
                padding:
                    const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                decoration: BoxDecoration(
                  color: carritoProvider.totalItems > 5
                      ? Colors.red
                      : Colors.white.withOpacity(0.2),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                  '${carritoProvider.totalItems}/5 ternos',
      ...
      body: carritoProvider.estaVacio
          ...
          : Column(
              children: [
                ...
                if (carritoProvider.totalItems >= 4)
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            carritoProvider.totalItems >= 5
                                ? '¡Has alcanzado el límite de 5 ternos por día!'
                                : 'Estás cerca del límite (máx. 5 ternos por día)',
                            style: TextStyle(
                              color: carritoProvider.totalItems >= 5
                                  ? Colors.red.shade900
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // ✅ ARREGLADO: Columna en lugar de Row
                                    Column(
                                      crossAxisAlignment:
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () {
                                                  // ✅ MANEJO DE ERRORES al incrementar
                                                  try {
                                                    carritoProvider
                                                        .incrementarCantidad(
                                                            terno.id);
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            // ✅ ARREGLADO: FittedBox para precios grandes
                            Flexible(
                              child: FittedBox(
                                fit: BoxFit.scaleDown,
                                child: Text(
